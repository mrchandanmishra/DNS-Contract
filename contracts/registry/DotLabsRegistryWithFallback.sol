...
import "./DotLabs.sol";
import "./DotLabsRegistry.sol";

/**
 * The dotlabs registry contract.
 */
contract DotLabsRegistryWithFallback is DotLabsRegistry {
    DotLabs public old;

    /**
     * @dev Constructs a new dotlabs registrar.
     */
    constructor(DotLabs _old) public DotLabsRegistry() {
        old = _old;
    }
