 ...
 * making it possible to make a single smart contract call to resolve an dotlabs name.
 */
contract UniversalResolver is ERC165, Ownable {
    ...
    DotLabs public immutable registry;

    constructor(address _registry, string[] memory _urls) {
        registry = DotLabs(_registry);
    ...
    /**
     * @dev Performs dotlabs name resolution for the supplied name and resolution data.
     * @param name The name to resolve, in normalised and DNS-encoded form.
     * @param data The resolution data, as specified in dotlabsIP-10.
    ...
    /**
     * @dev Performs dotlabs name reverse resolution for the supplied reverse name.
